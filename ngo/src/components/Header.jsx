...
export const Header = () => {
  return (
    <>
      <div className="container" id="first-box">
        <a href="" id="contact-email-a">
          {/* image icon of email and email in text */}
        ...
        <a href="" id="contact-number-a">
          {/* Image icon in call and calling number */}
        ...
        <button id="text-btn">
          {/* image of personal text message */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
