      ...
      <div className="herosetion">
        <div className="herosetionPart1">
          ...
          <div className="herosetionDescription">
            <h3>
              This tagline reflects the essence of creating meaningful impact
              through small, consistent efforts that lead to transformative
              changes in society.
            </h3>
        ...
        <div className="herosetionPart2">
          <img
            src="https://dropsofchange.in/wp-content/uploads/2023/02/WhatsApp-Image-2023-02-12-at-14.54.33.jpg"
            alt=""
          />
        </div>
      </div>
